...
(15, 17, 'nyeri otot', 'nyeri otot', 'nyeri otot', '10.Z0001.1');
...
(25, 'A 00 3', '10.A0001.2', '21:17:26', 'farmasi', 'Poli Umum', 2, '2021-12-12', '2021-12-12 21:17:26'),
...
(37, 'A 00 1', '10.K0001.1', '06:01:57', 'farmasi', 'Poli Umum', 1, '2021-12-24', '2021-12-24 06:01:58'),
(38, 'A 00 1', '10.Z0001.1', '17:29:10', 'pembayaran', 'Poli Umum', 1, '2021-12-26', '2021-12-26 17:29:10');
...
(100000062, '1', 1, '2021-12-26', 'hapus', 1);
...
(12, 17, '10.Z0001.1', '2021-12-26', '0000-00-00 00:00:00', 'nyeri otot', 'nyeri otot', 'nyeri otot', 'subjective Zunia Rahma', 150, 50, 22.2, 35, 60, 90, 120, 'objective Zunia Rahma', 'Analysis Zunia Rahma', 'Planning Zunia Rahma', '0000-00-00 00:00:00', 'hihi');
...
(20, 'Zunia Rahma', 'Perempuan', 'zunia rahma', '10.Z0001', 'mojolangu, lowokwaru, malang', 'pedagang', '1994-02-08', 27, 'BPJS', '12345', 'islam', '081235444555', 'Kepala Keluarga', '10.Z0001.1', '2021-12-26 17:26:13', '2021-12-26 17:26:13');
...
(8, 17, '1-00', 'asam urat', 'Primer', 'Baru', '10.Z0001.1', 'tersedia');
...
('zunia rahma', 'mojolangu, lowokwaru, malang', 'mojolangu', 'lowokwaru', 'malang', '085744455566', NULL, '10.Z0001', '2021-12-26 08:46:50', '2021-12-26 08:46:50');
...
(11, 17, 150, 50, 22.2, 35, 60, 90, 120, '10.Z0001.1');
...
('A 00 1', 'Zunia Rahma', '10.Z0001.1', '2021-12-26', 'Baru', 'Poli Umum', '17:29:10', '2021-12-26 17:29:10', '2021-12-26 17:29:10');
...
(17, '2021-12-26', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'ciiiia', 'Yulia Rahayu Putri', '10.Z0001.1'),
(18, '2021-12-26', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, 'Yulia Rahayu Putri', '10.Z0001.1');
...
(43, 17, 'Racikan', 'signa obat zunia', '3x2');
...
(6, 17, 'rewrw899', 'keterangan tindakan rewrw899 zunia', '2021-12-26 05:38:05', 'Masuk', 'ciiiia', '10.Z0001.1', 'Please select');
...
--
ALTER TABLE `tbl_anamnesa_rm`
  MODIFY `id_anamnesa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tbl_antrian_poli_umums`
--
ALTER TABLE `tbl_antrian_poli_umums`
  MODIFY `id_antrian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `tbl_antri_pendaftaran`
--
ALTER TABLE `tbl_antri_pendaftaran`
  MODIFY `id_antrian` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100000063;

--
-- AUTO_INCREMENT for table `tbl_asuhan_keperawatan`
--
ALTER TABLE `tbl_asuhan_keperawatan`
  MODIFY `id_askep` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_pemeriksaan_rm`
  MODIFY `id_pemeriksaan_objek` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
