                    ...
                    <div class="card-body">
                       ...
                       <div class="card-footer"> 
                            <div class="col-md-6 rounded-button">
                                <button type="button" class="btn mb-1 btn-rounded btn-primary float-right" data-toggle="modal" data-target="#basicModal1">Print</button>
                            </div>
                            <div class="col-md-6 rounded-button">
                                ...
                                @csrf
                                    ...
                                    <button class="btn mb-1 btn-rounded btn-warning float-right text-white mr-2">Simpan</button>  
                                </form>
                            </div>
