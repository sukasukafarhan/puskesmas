                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            @foreach($pasien as $a)
                                ...
                                <tr>
                                    ...
                                    <span>
                                            <button type="button" class="btn btn-light" onclick="location.href='/datarekammedislab/laboratrmdatapasien/rm/{{$a->no_index}}'" data-toggle="tooltip" data-placement="top" title="Buka">
