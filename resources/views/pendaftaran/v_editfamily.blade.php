                    ...
                    <div class="table-responsive">
                        <div class="container">
                            ...
                            @csrf <!-- {{ csrf_field() }} -->
                                ...
                                <input type="hidden" name="segment" id="segment" class="form-control" value="{{$segment[0]}}"  autofocuse>
                                ...
                                <input type="text" name="nama_kk" id="inputNamaKK" class="form-control" placeholder="Nama KK" value="{{$family[0]->nama_kk}}" required autofocuse>
                                <br>
                                <label for="inputAlamat">Alamat</label>
                                <input type="text" name="alamat" id="inpuAlamat" class="form-control" placeholder="Alamat Lengkap" value="{{$family[0]->alamat}}" required autofocuse>
                                <br>
                                <label for="inputDesa">Desa</label>
                                <input type="text" name="desa" id="inputDesa" class="form-control" placeholder="Nama Desa" value="{{$family[0]->desa}}" required autofocuse>
                                <br>
                                <label for="inputKecamatan">Kecamatan</label>
                                <input type="text" name="kecamatan" id="inputKecamatan" class="form-control" placeholder="Nama Kecamatan" value="{{$family[0]->kecamatan}}" required autofocuse>
                                <br>
                                <label for="inputKabupaten">Kabupaten</label>
                                <input type="text" name="kabupaten" id="inputKabupaten" class="form-control" placeholder="Nama Kabupaten" value="{{$family[0]->kabupaten}}" required autofocuse>
                                <br>
