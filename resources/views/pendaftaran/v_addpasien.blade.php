                        ...
                        @csrf <!-- {{ csrf_field() }} -->
                            ...
                            <div class="form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir" onchange="cari();"> <span class="input-group-append"><span class="input-group-text"><i class="mdi mdi-calendar-check"></i></span></span>
                                </div>
                            </div>
